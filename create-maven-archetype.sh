...
sed -i.bk "s|graalvm-springwebflux-blank|projectName|g" pom.xml
sed -i.bk "s|github\.com/making/projectName|github.com/making/graalvm-springwebflux-blank|g" pom.xml
mv src/main/resources/META-INF/native-image/am.ik.archetype/graalvm-springwebflux-blank src/main/resources/META-INF/native-image/am.ik.archetype/projectName
...
sed -i.bk "s|projectName|graalvm-springwebflux-blank|g" pom.xml
